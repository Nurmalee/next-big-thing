...
import { Whatshot, Code, BubbleChart } from '@material-ui/icons';
...
const AboutMeAndServices = () => {
    return (
        <div className={styles.container} id="services">

            <h1> Hi, I’m Nurudeen. Nice to have you here. </h1>

            <p> <strong> A little intro: </strong> Since beginning my journey as a web developer just about a year ago, I&apos;ve built personal projects, cloned popular websites and webapps, done remote works for startups, and collaborated with talented individuals to create business and/or consumer products. I&apos;m quietly confident, subconsciously meticulous, and constantly working on improving my abilities with steady pace. </p>
...
export default AboutMeAndServices
