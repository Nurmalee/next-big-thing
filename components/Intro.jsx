...
const Intro = () => {
	return (
		<div className='px-4 md:px-20 mx-auto my-0 flex flex-col text-center items-center justify-center text-[#0f2948] w-full md:w-[90vw] max-w-[1350px] h-[90vh] min-h-[700px]'>
