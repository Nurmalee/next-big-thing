        ...
        <div className={styles.container} id='home'>
            <div className={styles.content}>
                ...
                <div className={styles.buttons}>
                    <a href="https://drive.google.com/file/d/1Fo7k33QPL-uZa2i9XFWBrWhd69Q1HXVS/view?usp=sharing" download target="_blank" rel="noreferrer"> download my CV <CloudDownload style={{marginLeft: "10px"}} /> </a>
